...
<a3<end generate>a3>
    ...
    set_property -dict [list \
        ...
        CONFIG.ADC_DUAL {true} \
    	CONFIG.ADC_VREF_IS_DOUBLE {true}  \
    	CONFIG.NUMBER_PROBES {16}   \
    	CONFIG.COUNTER_BITS {32}   \
    	CONFIG.POWER_DEPTH {131072}  \
    	...
    	CONFIG.C_S01_AXI_ADDR_WIDTH {19.0} \
    ...
    connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
                        ...
                        # s01_axi_aclk, s_sniifer_in_axi_aclk and m_sniffer_out_axi_aclk are not used, but the ip does not disable the pins
    ...
    connect_bd_net [get_bd_pins reset_0/peripheral_aresetn] \
                        ...
                        # s01_axi_aresetn, s_sniifer_in_axi_aresetn and m_sniffer_out_axi_aresetn are not used, but the ip does not disable the pins
...
<a3<end generate>a3>
    ...
    create_bd_addr_seg -range 64K -offset 0xa0100000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs {monitor_0/s00_axi/reg0}] SEG2

    # create_bd_addr_seg -range 512K -offset 0xb0100000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs {monitor_0/s01_axi/reg0}] SEG3
    create_bd_addr_seg -range 128K -offset 0xb0180000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs {monitor_0/s02_axi/reg0}] SEG3
