...
<a3<end generate>a3>
    ...
    set_property -dict [ list CONFIG.NUM_MI {2} CONFIG.NUM_SI {1}] [get_bd_cells axi_dma_0_interconnect]
    ...
    connect_bd_intf_net -intf_net axi_dma_0_interconnect_M01_AXI [get_bd_intf_pins axi_dma_0_interconnect/M01_AXI] [get_bd_intf_pins monitor_0/s02_axi]
    ...
    connect_bd_net [get_bd_pins reset_0/peripheral_aresetn] \
                        ...
                        # s01_axi_aresetn, s_sniffer_in_axi_aresetn and m_sniffer_out_axi_aresetn are not used, but the ip does not disable the pins
...
<a3<end generate>a3>
    ...
    create_bd_addr_seg -range 128k -offset 0x20040000 [get_bd_addr_spaces monitor_cdma_0/Data] [get_bd_addr_segs {monitor_0/s02_axi/reg0}] SEG5
